...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Thêm xe/</span> Thêm xe cho thuê</h4>
        ...
        <div class="card-body">
            <form action="them-san-pham" method="post" enctype="multipart/form-data"> 
             ...
             <div class="mb-3 col-lg-6">
                ...
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Nhập tên xe" name="ten_xe" />
            </div>
            <div class="mb-3 col-lg-6">
                <label class="form-label" for="basic-default-fullname">Đơn giá</label>
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Đơn giá" name="don_gia" />
           </div>
            <div class="mb-3 col-lg-6">
                <label class="form-label" for="basic-default-fullname">Giảm giá</label>
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Giảm giá" name="giam_gia" />
            </div>
            <div class="mb-3 col-lg-6">
                <label class="form-label" for="basic-default-fullname">Vị trí</label>
                <input type="text" class="form-control" id="basic-default-fullname" placeholder="Nhập vị trí" name="vitri" />
            </div>
            <div class="mb-3 col-lg-6">
                <label class="form-label" for="basic-default-fullname">Chỗ ngồi</label>
                <input type="text" class="form-control" id="basic-default-fullname"  placeholder="Chỗ ngồi" name="chongoi" />
            </div>
            <div class="mb-3 col-lg-6">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control"  id="basic-default-fullname" placeholder="Mô tả" name="mota" />
            </div>
            </div>
             </div>
